# |  Edge pipeline v4: SSP1/SSP2/SSP3 x {OFF, ON}, all with shifting cultivation ON
...
# |  Shifting cultivation: s35_forest_damage=1 (persistent, no fade-out)
# |  Usage: cd magpie && Rscript scripts/start/projects/edge_v4_shiftON.R
...
set_ssp <- function(cfg, ssp) {
  ...
  # Shifting cultivation ON (persistent, no fade-out)
