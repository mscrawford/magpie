...
parameters
 ...
 p32_degr_applied(t,j,ac)                           Combined vegc deficit fraction applied to the natural-curve afforestation pools in this step - the previous step's 35_natveg factor (1)
 p32_vegc_unreduced(t,j,type32,ac)                  Vegc density of the afforestation pools before the degradation factor (tC per ha)
 p32_degr_committed(t,j,type32,ac)                  Committed vegc deficit stock on the solved natural-curve afforestation pools (mio. tC)
